...
static const char col_gray2[]       = "#403c58";
static const char col_gray3[]       = "#ebbcba";
static const char col_gray4[]       = "#f6c177";
static const char col_cyan[]        = "#c4a7e7";

static char bgd[]               = "#1f1d29";  /* Background  */
static char fgd[]               = "#9bced7";  /* Foreground */
static char col0[]              = "#403c58";  /* Black */ 
static char col1[]              = "#ea6f91";  /* Red */ 
static char col2[]              = "#9bced7";  /* Green */ 
static char col3[]              = "#f1ca93";  /* Yellow */ 
static char col4[]              = "#34738e";  /* Blue */ 
static char col5[]              = "#c3a5e6";  /* Magenta */ 
static char col6[]              = "#eabbb9";  /* Cyan */ 
static char col7[]              = "#faebd7";  /* White */ 
static char col8[]              = "#6f6e85";  /* Bright Black */ 
static char col9[]              = "#ea6f91";  /* Bright Red */ 
static char col10[]             = "#9bced7";  /* Bright Green */ 
static char col11[]             = "#f1ca93";  /* Bright Yellow */ 
static char col12[]             = "#34738e";  /* Bright Blue */ 
static char col13[]             = "#c3a5e6";  /* Bright Magenta */ 
static char col14[]             = "#eabbb9";  /* Bright Cyan */ 
